...
=============================================================================
 ...
 Version 1.0  (No-AI, keyword/pattern matching)
...
ACTIONS = [
    ...
    # ── SARA Control ──────────────────────────────────────────────────────────
    # These let the user type natural English to control SARA itself.
    # sara entrypoint handles these keywords directly; dispatcher routes them.
    {
        "action": "activate",
        "patterns": [
            r"^activate\s+sara$",
            r"^start\s+sara$",
            r"^wake\s+(up\s+)?sara$",
            r"^sara\s+(activate|start|wake\s+up)$",
            r"^turn\s+on\s+sara$",
            r"^enable\s+sara$",
        ],
        "default_query": "",
    ...
    },
    {
        ...
        "patterns": [
            r"^sara\s+status$",
            r"^status\s+of\s+sara$",
            r"^(is\s+)?sara\s+(running|active|alive|on)\??$",
        ],
        "default_query": "",
        "query_passthrough": False,
    },
